/**
 * 这里改的就是setBodyStyle方法里面计算设定宽高的逻辑，就是加了高
 * rowWidth += ($.scrollbarSize() + 2);
...
export default class Style {
    ...
    setBodyStyle() {
        ...
        let rowWidth = $.style(firstRow, 'width');
        const hasVerticalOverflow = $.hasVerticalOverflow(this.bodyScrollable);
